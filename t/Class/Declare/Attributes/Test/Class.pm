...
# $Id: Class.pm,v 1.1 2003/06/05 18:19:29 ian Exp $
#
# Class::Declare::Attributes::Test helper class
package Class::Declare::Attributes::Test::Class;
...
package Class::Declare::Attributes::Test::Class::Derived;

use strict;
use warnings;

use base qw( Class::Declare::Attributes::Test::Class );
...
package Class::Declare::Attributes::Test::Class::Unrelated;
